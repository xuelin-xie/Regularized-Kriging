...
URMSE1(i)=sqTR(sum((EY -UK).*(EY -UK)) /size(EY,1));
...
TRRMSE2(i)=sqTR(sum((EY -TRLK).*(EY -TRLK)) /size(EY,1));
...
TRRMSE3(i)=sqTR(sum((EY -TRRK).*(EY -TRRK)) /size(EY,1));
...
TRRMSE4(i)=sqTR(sum((EY -EK).*(EY -EK)) /size(EY,1));
...
PBRMSE2(i)=sqTR(sum((EY -PBLK).*(EY -PBLK)) /size(EY,1));
...
PBRMSE3(i)=sqTR(sum((EY -PBRK).*(EY -PBRK)) /size(EY,1));
...
PBRMSE4(i)=sqTR(sum((EY -PBEK).*(EY -PBEK)) /size(EY,1));
